...
\begin{figure}[ht]
    \centering
    \subfloat[Birds 1]{%
        \includegraphics[width=0.45\linewidth]{./results/birds1.jpg}%
        }%
        \xspace
    \subfloat[Birds 2]{%
        \includegraphics[width=0.45\linewidth]{./results/birds2.jpg}%
        }%
        \xspace
    \subfloat[Beans 1]{%
        \includegraphics[width=0.45\linewidth]{./results/kitniot0.jpg}%
        }%
        \xspace
    \subfloat[Beans 2]{%
        \includegraphics[width=0.45\linewidth]{./results/kitniot1.jpg}%
        }%
\end{figure}
\newpage
...
[7]\verb|https://www.investopedia.com/terms/z/zscore.asp#:~:text=Investopedia%20%2F%20Tara%20Anand-,What%20Is%20Z%2DScore%3F,identical%20to%20the%20mean%20score.|
